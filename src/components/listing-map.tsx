...
export default function ListingMap(props: ListingMapProps) {
  ...
  useEffect(() => {
    ...
    map.on("style.load", () => {
      ...
      map.addLayer({ id: "focus-fill", type: "fill", source: "focus", paint: { "fill-color": "#c8372d", "fill-opacity": 0.09 } });
      map.addLayer({
        id: "focus-line",
        type: "line",
        source: "focus",
        paint: { "line-color": "#c8372d", "line-width": 2, "line-dasharray": [2, 1.5], "line-opacity": 0.7 },
      });
      setReady(true);
    });
